...
createServer(async (req, res) => {
  try {
    ...
    if (basePath && requestedPath === basePath) { res.writeHead(308, { Location: `${basePath}/` }).end(); return; }
    if (basePath && !requestedPath.startsWith(`${basePath}/`)) { res.writeHead(404).end("Not found"); return; }
